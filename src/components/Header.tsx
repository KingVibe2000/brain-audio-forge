          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 bg-card border border-border rounded-lg shadow-lg p-1">
              <DropdownMenuItem className="flex items-center gap-3 px-3 py-2 hover:bg-accent/10 cursor-pointer rounded-md">
                ...
                <span className="font-sans text-foreground">Business Book Settings</span>
              </DropdownMenuItem>
              <DropdownMenuItem className="flex items-center gap-3 px-3 py-2 hover:bg-accent/10 cursor-pointer rounded-md">
                <div className="w-3 h-3 border border-muted-foreground/60 rounded-full"></div>
                <span className="font-sans text-foreground">Self Improvement Settings</span>
              </DropdownMenuItem>
              <DropdownMenuItem className="flex items-center gap-3 px-3 py-2 hover:bg-accent/10 cursor-pointer rounded-md">
                <div className="w-3 h-3 border border-muted-foreground/60 rounded-full"></div>
                <span className="font-sans text-foreground">Author Settings</span>
              </DropdownMenuItem>
              <DropdownMenuItem className="flex items-center gap-3 px-3 py-2 hover:bg-accent/10 cursor-pointer rounded-md">
                <div className="w-3 h-3 border border-muted-foreground/60 rounded-full"></div>
                <span className="font-sans text-foreground">Admin</span>
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
          ...
          <SheetContent side="right" className="w-80">
            <div className="flex flex-col space-y-4 mt-8">
              ...
              <div className="space-y-2">
                <div className="px-3 py-2 text-sm font-medium text-muted-foreground font-sans">Settings</div>
                <Button variant="ghost" className="font-sans justify-start text-muted-foreground hover:text-foreground h-12 w-full">
